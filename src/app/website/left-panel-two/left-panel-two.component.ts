...
@Component({
  selector: 'app-left-panel-two',
  templateUrl: './left-panel-two.component.html',
  styleUrls: ['./left-panel-two.component.css']
})
export class LeftPanelTwoComponent implements OnInit {
