...
@Component({
  ...
  styleUrls: ['./grievanceform.component.css'],
})
export class GrievanceformComponent implements OnInit {
  ...
  onSubmit() {
    if (this.GrievanceForm.value.submissiontype == 'G') {
      ...
      this.GrievanceFormControls.grievancetype.setValidators([
        Validators.required,
      ]);
      this.GrievanceFormControls.grievancetype.updateValueAndValidity();

      this.GrievanceFormControls.grievancedesc.setValidators([
        Validators.required,
      ]);
      this.GrievanceFormControls.grievancedesc.updateValueAndValidity();

      this.GrievanceFormControls.fileupload.setValidators([
        Validators.required,
      ]);
      this.GrievanceFormControls.fileupload.updateValueAndValidity();
    } else {
      this.GrievanceFormControls.suggetiondescription.setValidators([
        Validators.required,
      ]);
      this.GrievanceFormControls.suggetiondescription.updateValueAndValidity();
    ...
    // if(this.utils.decrypt(sessionStorage.getItem("Capchid")) !=this.GrievanceForm.value.captchacode)
    // {
    ...
    if (!this.GrievanceForm.valid) return;
